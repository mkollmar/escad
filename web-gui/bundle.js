...
(() => {
    ...
    "node_modules/cytoscape/dist/cytoscape.cjs.js"(exports, module) {
      ...
      var elesfn$q = {
        ...
        layoutPositions: function layoutPositions(layout2, options, fn2) {
          ...
          if (options.animate) {
            ...
            if (options.fit) {
              cy2.fit(options.eles, options.padding);
            }
            if (options.zoom != null) {
              cy2.zoom(options.zoom);
            }
            if (options.pan) {
              cy2.pan(options.pan);
            }
        ...
        layout: function layout2(options) {
          var cy2 = this.cy();
          return cy2.makeLayout(extend({}, options, {
            eles: this
          }));
        }
      };
      ...
      var corefn$3 = {
        layout: function layout2(options) {
          ...
          if (string(options.eles)) {
            eles = cy2.$(options.eles);
          } else {
            eles = options.eles != null ? options.eles : cy2.$();
          }
      ...
      var corefn$5 = {
        ...
        initRenderer: function initRenderer(options) {
          var cy2 = this;
          var RendererProto = cy2.extension("renderer", options.name);
      ...
      extend(corefn$9, {
        ...
        mount: function mount(container) {
          ...
          cy2.invalidateSize();
          cy2.initRenderer(extend({}, options, options.renderer, {
            name: options.renderer.name === "null" ? "canvas" : options.renderer.name
          }));
          cy2.startAnimationLoop();
          cy2.style(options.style);
          cy2.emit("mount");
          return cy2;
        },
      ...
      CoseLayout.prototype.run = function() {
        ...
        var layoutInfo = createLayoutInfo(cy2, layout2, options);
        if (DEBUG) {
        ...
        var refresh = function refresh2() {
          refreshPositions(layoutInfo, cy2, options);
          if (options.fit === true) {
            cy2.fit(options.padding);
          }
        };
      ...
      var createLayoutInfo = function createLayoutInfo2(cy2, layout2, options) {
      ...
      var refreshPositions = function refreshPositions2(layoutInfo, cy2, options) {
  ...
  var require_cytoscape_context_menus = __commonJS({
    "node_modules/cytoscape-context-menus/cytoscape-context-menus.js"(exports, module) {
      !function(e, t) {
        typeof exports == "object" && typeof module == "object" ? module.exports = t() : typeof define == "function" && define.amd ? define([], t) : typeof exports == "object" ? exports.cytoscapeContextMenus = t() : e.cytoscapeContextMenus = t();
      }(self, function() {
        return (() => {
          var e = { 621: (e2, t2, n2) => {
            "use strict";
            ...
            function o(e3) {
              for (var t3 = "", n3 = 0; n3 < e3.length; n3++)
                t3 += e3[n3], n3 !== e3.length - 1 && (t3 += " ");
              return t3;
            }
            function r(e3, t3, n3) {
              n3 ? e3.setAttribute(t3, "") : e3.removeAttribute(t3);
            }
            function u(e3, t3, n3) {
              customElements.get(e3) === void 0 && customElements.define(e3, t3, { extends: n3 });
            }
            n2.r(t2), n2.d(t2, { contextMenus: () => O });
            var s = "cy-context-menus-divider", a = { evtType: "cxttap", menuItems: [], menuItemClasses: ["cy-context-menus-cxt-menuitem"], contextMenuClasses: ["cy-context-menus-cxt-menu"], submenuIndicator: { src: "assets/submenu-indicator-default.svg", width: 12, height: 12 } };
            function c(e3) {
              ...
              if (typeof Symbol == "undefined" || e3[Symbol.iterator] == null) {
                if (Array.isArray(e3) || (n3 = function(e4, t4) {
                  if (e4) {
                    ...
                    return n4 === "Object" && e4.constructor && (n4 = e4.constructor.name), n4 === "Map" || n4 === "Set" ? Array.from(e4) : n4 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n4) ? f(e4, t4) : void 0;
                  }
            ...
            function m(e3, t3, n3) {
              return t3 && h(e3.prototype, t3), n3 && h(e3, n3), e3;
            }
            function v(e3, t3) {
            ...
            function y(e3) {
              ...
              return function() {
                var n3, i2 = I(e3);
                if (t3) {
                  var o2 = I(this).constructor;
                  n3 = Reflect.construct(i2, arguments, o2);
                } else
            ...
            function p(e3, t3) {
              return !t3 || c(t3) !== "object" && typeof t3 != "function" ? b(e3) : t3;
            }
            function b(e3) {
              if (e3 === void 0)
            ...
            function g(e3, t3, n3) {
              return (g = typeof Reflect != "undefined" && Reflect.get ? Reflect.get : function(e4, t4, n4) {
                var i2 = function(e5, t5) {
                  for (; !Object.prototype.hasOwnProperty.call(e5, t5) && (e5 = I(e5)) !== null; )
                    ;
                  return e5;
                }(e4, t4);
                if (i2) {
                  var o2 = Object.getOwnPropertyDescriptor(i2, t4);
            ...
            function w(e3) {
              ...
              return (w = function(e4) {
                ...
                function i2() {
                  return x(e4, arguments, I(this).constructor);
                }
                return i2.prototype = Object.create(e4.prototype, { constructor: { value: i2, enumerable: false, writable: true, configurable: true } }), C(i2, e4);
              })(e3);
            }
            function x(e3, t3, n3) {
              return (x = M() ? Reflect.construct : function(e4, t4, n4) {
                var i2 = [null];
                i2.push.apply(i2, t4);
                var o2 = new (Function.bind.apply(e4, i2))();
                return n4 && C(o2, n4.prototype), o2;
            ...
            var E = function(e3) {
              v(n3, e3);
              var t3 = y(n3);
              function n3(e4, i2, o2) {
                var u2, s2, a2, c2, l2, f2, h2, m2, v2, y2;
                d(this, n3), g((s2 = b(y2 = t3.call(this)), I(n3.prototype)), "setAttribute", s2).call(s2, "id", e4.id);
                var p2 = y2._getMenuItemClassStr(o2.cxtMenuItemClasses, e4.hasTrailingDivider);
                if (g((a2 = b(y2), I(n3.prototype)), "setAttribute", a2).call(a2, "class", p2), g((c2 = b(y2), I(n3.prototype)), "setAttribute", c2).call(c2, "title", (u2 = e4.tooltipText) !== null && u2 !== void 0 ? u2 : ""), e4.disabled && r(b(y2), "disabled", true), e4.image) {
                  var w2 = document.createElement("img");
                  w2.src = e4.image.src, w2.width = e4.image.width, w2.height = e4.image.height, w2.style.position = "absolute", w2.style.top = e4.image.y + "px", w2.style.left = e4.image.x + "px", g((l2 = b(y2), I(n3.prototype)), "appendChild", l2).call(l2, w2);
                }
                if (y2.innerHTML += e4.content, y2.onMenuItemClick = i2, y2.data = {}, y2.clickFns = [], y2.selector = e4.selector, y2.hasTrailingDivider = e4.hasTrailingDivider, y2.show = e4.show === void 0 || e4.show, y2.coreAsWell = e4.coreAsWell || false, y2.scratchpad = o2, e4.onClickFunction === void 0 && e4.submenu === void 0)
                  throw new Error("A menu item must either have click function or a submenu or both");
                return y2.onClickFunction = e4.onClickFunction, e4.submenu instanceof Array && y2._createSubmenu(e4.submenu), g((f2 = b(y2), I(n3.prototype)), "addEventListener", f2).call(f2, "mousedown", k), g((h2 = b(y2), I(n3.prototype)), "addEventListener", h2).call(h2, "mouseup", k), g((m2 = b(y2), I(n3.prototype)), "addEventListener", m2).call(m2, "touchstart", k), g((v2 = b(y2), I(n3.prototype)), "addEventListener", v2).call(v2, "touchend", k), y2;
              }
              return m(n3, [{ key: "bindOnClickFunction", value: function(e4) {
                this.clickFns.push(e4), g(I(n3.prototype), "addEventListener", this).call(this, "click", e4);
              } }, { key: "unbindOnClickFunctions", value: function() {
                var e4, t4 = l(this.clickFns);
                try {
                  for (t4.s(); !(e4 = t4.n()).done; ) {
                    var i2 = e4.value;
                    g(I(n3.prototype), "removeEventListener", this).call(this, "click", i2);
                  }
                } catch (e5) {
                  t4.e(e5);
                } finally {
                ...
                r(this, "disabled", false), this.hasSubmenu() && this.addEventListener("mouseenter", this.mouseEnterHandler);
              } }, { key: "disable", value: function() {
                r(this, "disabled", true), this.hasSubmenu() && this.removeEventListener("mouseenter", this.mouseEnterHandler);
              } }, { key: "hide", value: function() {
                this.show = false, this.style.display = "none";
              } }, { key: "getHasTrailingDivider", value: function() {
                return !!this.hasTrailingDivider;
              } }, { key: "setHasTrailingDivider", value: function(e4) {
                this.hasTrailingDivider = e4;
              } }, { key: "hasSubmenu", value: function() {
                return this.submenu instanceof S;
              } }, { key: "appendSubmenuItem", value: function(e4) {
                var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
                this.hasSubmenu() || this._createSubmenu(), this.submenu.appendMenuItem(e4, t4);
              } }, { key: "isClickable", value: function() {
                return this.onClickFunction !== void 0;
              ...
              } }, { key: "_onMouseEnter", value: function(e4) {
                var t4 = this.getBoundingClientRect(), i2 = function(e5) {
                  e5.style.opacity = "0", e5.style.display = "block";
                  var t5 = e5.getBoundingClientRect();
                  return e5.style.opacity = "1", e5.style.display = "none", t5;
                }(this.submenu), o2 = t4.right + i2.width > window.innerWidth, r2 = t4.top + i2.height > window.innerHeight;
                o2 || r2 ? o2 && !r2 ? (this.submenu.style.right = this.clientWidth + "px", this.submenu.style.top = "0px", this.submenu.style.left = "auto", this.submenu.style.bottom = "auto") : o2 && r2 ? (this.submenu.style.right = this.clientWidth + "px", this.submenu.style.bottom = "0px", this.submenu.style.top = "auto", this.submenu.style.left = "auto") : (this.submenu.style.left = this.clientWidth + "px", this.submenu.style.bottom = "0px", this.submenu.style.right = "auto", this.submenu.style.top = "auto") : (this.submenu.style.left = this.clientWidth + "px", this.submenu.style.top = "0px", this.submenu.style.right = "auto", this.submenu.style.bottom = "auto"), this.submenu.display();
                var u2 = Array.from(this.submenu.children).filter(function(e5) {
                  if (e5 instanceof n3)
                    return e5.isVisible();
                }), a2 = u2.length;
                u2.forEach(function(e5, t5) {
                  e5 instanceof n3 && (t5 < a2 - 1 && e5.getHasTrailingDivider() ? e5.classList.add(s) : e5.getHasTrailingDivider() && e5.classList.remove(s));
                });
              } }, { key: "_onMouseLeave", value: function(e4) {
                var t4, n4, i2, o2, r2;
                t4 = { x: e4.clientX, y: e4.clientY }, n4 = this.submenu, o2 = t4.y, (i2 = t4.x) >= (r2 = n4.getBoundingClientRect()).left && i2 <= r2.right && o2 >= r2.top && o2 <= r2.bottom || this.submenu.hide();
                ...
                try {
                  for (i2.s(); !(t4 = i2.n()).done; ) {
                    var o2 = t4.value, r2 = new n3(o2, this.onMenuItemClick, this.scratchpad);
                    this.submenu.appendMenuItem(r2);
                  }
                } catch (e5) {
                  i2.e(e5);
                } finally {
              ...
              } }, { key: "_getMenuItemClassStr", value: function(e4, t4) {
                return t4 ? e4 + " " + s : e4;
              } }], [{ key: "define", value: function() {
                u("ctx-menu-item", n3, "button");
              } }]), n3;
            }(w(HTMLButtonElement)), S = function(e3) {
              v(n3, e3);
              var t3 = y(n3);
              function n3(e4, i2) {
                var o2, r2;
                return d(this, n3), g((o2 = b(r2 = t3.call(this)), I(n3.prototype)), "setAttribute", o2).call(o2, "class", i2.cxtMenuClasses), r2.style.position = "absolute", r2.onMenuItemClick = e4, r2.scratchpad = i2, r2;
              }
              return m(n3, [{ key: "hide", value: function() {
                ...
                var e4, t4 = l(this.children);
                try {
                  for (t4.s(); !(e4 = t4.n()).done; ) {
                    var n4 = e4.value;
                    n4 instanceof HTMLElement ? n4.style.display = "none" : console.warn("".concat(n4, " is not a HTMLElement"));
                  }
                } catch (e5) {
                  t4.e(e5);
                } finally {
                ...
                try {
                  for (t4.s(); !(e4 = t4.n()).done; ) {
                    var n4 = e4.value;
                    n4 instanceof E && n4.submenu && n4.submenu.hide();
                  }
                } catch (e5) {
                  t4.e(e5);
                } finally {
              ...
              } }, { key: "appendMenuItem", value: function(e4) {
                var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
                if (t4 !== void 0) {
                  if (t4.parentNode !== this)
                    throw new Error("The item with id='".concat(t4.id, "' is not a child of the context menu"));
                  this.insertBefore(e4, t4);
                } else
                  this.appendChild(e4);
                e4.isClickable() && this._performBindings(e4);
              } }, { key: "moveBefore", value: function(e4, t4) {
                if (e4.parentNode !== this)
                  throw new Error("The item with id='".concat(e4.id, "' is not a child of context menu"));
                if (t4.parentNode !== this)
                  throw new Error("The item with id='".concat(t4.id, "' is not a child of context menu"));
                this.removeChild(e4), this.insertBefore(e4, t4);
              } }, { key: "removeAllMenuItems", value: function() {
                for (; this.firstChild; ) {
                  var e4 = this.lastChild;
                  e4 instanceof E ? this._removeImmediateMenuItem(e4) : (console.warn("Found non menu item in the context menu: ", e4), this.removeChild(e4));
                }
              } }, { key: "_removeImmediateMenuItem", value: function(e4) {
                if (!this._detachImmediateMenuItem(e4))
                  throw new Error("menu item(id=".concat(e4.id, ") is not in the context menu"));
                e4.detachSubmenu(), e4.unbindOnClickFunctions();
              } }, { key: "_detachImmediateMenuItem", value: function(e4) {
                if (e4.parentNode === this) {
                  if (this.removeChild(e4), this.children.length <= 0) {
                    var t4 = this.parentNode;
                    t4 instanceof E && t4.detachSubmenu();
                  }
                  return true;
                }
                return false;
              } }, { key: "_performBindings", value: function(e4) {
                var t4 = this._bindOnClick(e4.onClickFunction);
                e4.bindOnClickFunction(t4), e4.bindOnClickFunction(this.onMenuItemClick);
              } }, { key: "_bindOnClick", value: function(e4) {
                var t4 = this;
                return function() {
                  var n4 = t4.scratchpad.currentCyEvent;
                  e4(n4);
                };
              } }], [{ key: "define", value: function() {
                u("menu-item-list", n3, "div");
              } }]), n3;
            }(w(HTMLDivElement)), T = function(e3) {
              v(n3, e3);
              var t3 = y(n3);
              function n3(e4, i2) {
                var o2;
                return d(this, n3), (o2 = t3.call(this, e4, i2)).onMenuItemClick = function(t4) {
                  k(t4), o2.hide(), e4();
                }, o2;
              }
              return m(n3, [{ key: "removeMenuItem", value: function(e4) {
                var t4 = e4.parentElement;
                t4 instanceof S && this.contains(t4) && t4._removeImmediateMenuItem(e4);
              } }, { key: "appendMenuItem", value: function(e4) {
                var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
                this.ensureDoesntContain(e4.id), g(I(n3.prototype), "appendMenuItem", this).call(this, e4, t4);
              } }, { key: "insertMenuItem", value: function(e4) {
                var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n4 = t4.before, i2 = t4.parent;
                if (this.ensureDoesntContain(e4.id), n4 !== void 0) {
                  if (!this.contains(n4))
                    throw new Error("before(id=".concat(n4.id, ") is not in the context menu"));
                  var o2 = n4.parentNode;
                  if (!(o2 instanceof S))
                    throw new Error("Parent of before(id=".concat(n4.id, ") is not a submenu"));
                  o2.appendMenuItem(e4, n4);
                } else if (i2 !== void 0) {
                  if (!this.contains(i2))
                    throw new Error("parent(id=".concat(i2.id, ") is not a descendant of the context menu"));
                  i2.appendSubmenuItem(e4);
                } else
                  this.appendMenuItem(e4);
              } }, { key: "moveBefore", value: function(e4, t4) {
                var n4 = e4.parentElement;
                if (!this.contains(n4))
                  throw new Error("parent(id=".concat(n4.id, ") is not in the contex menu"));
                if (!this.contains(t4))
                  throw new Error("before(id=".concat(t4.id, ") is not in the context menu"));
                n4.removeChild(e4), this.insertMenuItem(e4, { before: t4 });
              } }, { key: "moveToSubmenu", value: function(e4) {
                var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, n4 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, i2 = e4.parentElement;
                if (!(i2 instanceof S))
                  throw new Error("current parent(id=".concat(i2.id, ") is not a submenu"));
                if (!this.contains(i2))
                  throw new Error("parent of the menu item(id=".concat(i2.id, ") is not in the context menu"));
                if (t4 !== null) {
                  if (!this.contains(t4))
                    throw new Error("parent(id=".concat(t4.id, ") is not in the context menu"));
                  i2._detachImmediateMenuItem(e4), t4.appendSubmenuItem(e4);
                } else
                  n4 !== null && (e4.selector = n4.selector, e4.coreAsWell = n4.coreAsWell), i2._detachImmediateMenuItem(e4), this.appendMenuItem(e4);
              } }, { key: "ensureDoesntContain", value: function(e4) {
                var t4 = document.getElementById(e4);
                if (t4 !== void 0 && this.contains(t4))
                  throw new Error("There is already an element with id=".concat(e4, " in the context menu"));
              } }], [{ key: "define", value: function() {
                u("ctx-menu", n3, "div");
              } }]), n3;
            }(S);
            ...
            function O(e3) {
              var t3 = this;
              t3.scratch("cycontextmenus") || t3.scratch("cycontextmenus", {});
              var n3, r2, u2 = function(e4) {
                return t3.scratch("cycontextmenus")[e4];
              }, c2 = function(e4, n4) {
                return t3.scratch("cycontextmenus")[e4] = n4;
              }, l2 = u2("options"), f2 = u2("cxtMenu"), d2 = function(e4) {
                var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0, n4 = m2(e4);
                if (t4 !== void 0) {
                  var i2 = y2(t4);
                  f2.insertMenuItem(n4, { parent: i2 });
                } else
                  f2.insertMenuItem(n4);
              }, h2 = function(e4) {
                for (var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0, n4 = 0; n4 < e4.length; n4++)
                  d2(e4[n4], t4);
              }, m2 = function(e4) {
                var n4 = t3.scratch("cycontextmenus");
                return new E(e4, f2.onMenuItemClick, n4);
              }, v2 = function() {
                u2("active") && (f2.removeAllMenuItems(), t3.off("tapstart", u2("eventCyTapStart")), t3.off(l2.evtType, u2("onCxttap")), t3.off("viewport", u2("onViewport")), document.removeEventListener("mouseup", u2("hideOnNonCyClick")), f2.parentNode.removeChild(f2), f2 = void 0, c2("cxtMenu", void 0), c2("active", false), c2("anyVisibleChild", false), c2("onCxttap", void 0), c2("onViewport", void 0), c2("hideOnNonCyClick", void 0));
              }, y2 = function(e4) {
                var t4 = document.getElementById(e4);
                if (t4 instanceof E)
                  return t4;
                throw new Error("The item with id=".concat(e4, " is not a menu item"));
              };
              if (e3 !== "get") {
                E.define(), S.define(), T.define(), l2 = function(e4, t4) {
                  var n4 = {};
                  for (var i2 in e4)
                    n4[i2] = e4[i2];
                  for (var o2 in t4)
                    n4[o2] instanceof Array ? n4[o2] = n4[o2].concat(t4[o2]) : n4[o2] = t4[o2];
                  return n4;
                }(a, e3), c2("options", l2), u2("active") && v2(), c2("active", true), c2("submenuIndicatorGen", function(e4) {
                  var t4 = document.createElement("img");
                  return t4.src = e4.src, t4.width = e4.width, t4.height = e4.height, t4.classList.add("cy-context-menus-submenu-indicator"), t4;
                }.bind(void 0, l2.submenuIndicator));
                var p2 = o(l2.contextMenuClasses);
                c2("cxtMenuClasses", p2);
                var b2 = t3.scratch("cycontextmenus");
                f2 = new T(function() {
                  return c2("cxtMenuPosition", void 0);
                }, b2), c2("cxtMenu", f2), t3.container().appendChild(f2), c2("cxtMenuItemClasses", o(l2.menuItemClasses));
                var g2 = l2.menuItems;
                h2(g2), r2 = function(e4) {
                  c2("currentCyEvent", e4), function(e5) {
                    var n5, i3 = t3.container(), o3 = u2("cxtMenuPosition"), r4 = e5.position || e5.cyPosition;
                    if (o3 != r4) {
                      f2.hideMenuItems(), c2("anyVisibleChild", false), c2("cxtMenuPosition", r4);
                      var s2 = { top: (n5 = i3.getBoundingClientRect()).top, left: n5.left }, a3 = e5.renderedPosition || e5.cyRenderedPosition, l4 = getComputedStyle(i3)["border-width"], d3 = parseInt(l4.replace("px", "")) || 0;
                      d3 > 0 && (s2.top += d3, s2.left += d3);
                      var h3 = i3.clientHeight, m3 = i3.clientWidth, v3 = h3 / 2, y3 = m3 / 2;
                      a3.y > v3 && a3.x <= y3 ? (f2.style.left = a3.x + "px", f2.style.bottom = h3 - a3.y + "px", f2.style.right = "auto", f2.style.top = "auto") : a3.y > v3 && a3.x > y3 ? (f2.style.right = m3 - a3.x + "px", f2.style.bottom = h3 - a3.y + "px", f2.style.left = "auto", f2.style.top = "auto") : a3.y <= v3 && a3.x <= y3 ? (f2.style.left = a3.x + "px", f2.style.top = a3.y + "px", f2.style.right = "auto", f2.style.bottom = "auto") : (f2.style.right = m3 - a3.x + "px", f2.style.top = a3.y + "px", f2.style.left = "auto", f2.style.bottom = "auto");
                    }
                  }(e4);
                  var n4, i2 = e4.target || e4.cyTarget, o2 = function(e5, t4) {
                    var n5;
                    if (typeof Symbol == "undefined" || e5[Symbol.iterator] == null) {
                      if (Array.isArray(e5) || (n5 = function(e6, t5) {
                        if (e6) {
                          if (typeof e6 == "string")
                            return A(e6, t5);
                          var n6 = Object.prototype.toString.call(e6).slice(8, -1);
                          return n6 === "Object" && e6.constructor && (n6 = e6.constructor.name), n6 === "Map" || n6 === "Set" ? Array.from(e6) : n6 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n6) ? A(e6, t5) : void 0;
                        }
                    ...
                    var r4, u3 = true, s2 = false;
                    return { s: function() {
                      n5 = e5[Symbol.iterator]();
                    }, n: function() {
                      var e6 = n5.next();
                      return u3 = e6.done, e6;
                    }, e: function(e6) {
                      s2 = true, r4 = e6;
                    }, f: function() {
                      try {
                        u3 || n5.return == null || n5.return();
                      } finally {
                        if (s2)
                          throw r4;
                      }
                  ...
                  try {
                    for (o2.s(); !(n4 = o2.n()).done; ) {
                      var r3 = n4.value;
                      r3 instanceof E && (i2 === t3 ? r3.coreAsWell : i2.is(r3.selector)) && r3.show && (f2.display(), c2("anyVisibleChild", true), r3.display());
                    }
                  } catch (e5) {
                    o2.e(e5);
                  } finally {
                  ...
                  var a2 = Array.from(f2.children).filter(function(e5) {
                    if (e5 instanceof E)
                      return e5.isVisible();
                  }), l3 = a2.length;
                  a2.forEach(function(e5, t4) {
                    e5 instanceof E && (t4 < l3 - 1 && e5.getHasTrailingDivider() ? e5.classList.add(s) : e5.getHasTrailingDivider() && e5.classList.remove(s));
                  }), !u2("anyVisibleChild") && !function(e5) {
                    return e5.offsetWidth <= 0 && e5.offsetHeight <= 0 || e5.style && e5.style.display || getComputedStyle(e5).display;
                  }(f2) && f2.hide();
                }, t3.on(l2.evtType, r2), c2("onCxttap", r2), function() {
                  var e4 = function(e5) {
                    if (f2.contains(e5.originalEvent.target))
                      return false;
                    f2.hide(), c2("cxtMenuPosition", void 0), c2("currentCyEvent", void 0);
                  };
                  t3.on("tapstart", e4), c2("eventCyTapStart", e4);
                  var n4 = function() {
                    f2.hide();
                  };
                  t3.on("viewport", n4), c2("onViewport", n4);
                }(), n3 = function(e4) {
                  t3.container().contains(e4.target) || f2.contains(e4.target) || (f2.hide(), c2("cxtMenuPosition", void 0));
                }, document.addEventListener("mouseup", n3), c2("hideOnNonCyClick", n3), function() {
                    ...
                    if (typeof Symbol == "undefined" || e5[Symbol.iterator] == null) {
                      if (Array.isArray(e5) || (n4 = function(e6, t6) {
                        if (e6) {
                          ...
                          return n5 === "Object" && e6.constructor && (n5 = e6.constructor.name), n5 === "Map" || n5 === "Set" ? Array.from(e6) : n5 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n5) ? i(e6, t6) : void 0;
                        }
                        ...
                        return { s: r3, n: function() {
                          return o2 >= e5.length ? { done: true } : { done: false, value: e5[o2++] };
                        }, e: function(e6) {
                          throw e6;
                        }, f: r3 };
                      }
                  ...
                  try {
                    for (t4.s(); !(e4 = t4.n()).done; )
                      e4.value.addEventListener("contextmenu", function(e5) {
              ...
              return function(e4) {
                return { isActive: function() {
                  return u2("active");
                }, appendMenuItem: function(t4) {
                  var n4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
                  return d2(t4, n4), e4;
                }, appendMenuItems: function(t4) {
                  var n4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
                  return h2(t4, n4), e4;
                }, removeMenuItem: function(t4) {
                  var n4 = y2(t4);
                  return f2.removeMenuItem(n4), e4;
                }, setTrailingDivider: function(t4, n4) {
                  var i2 = y2(t4);
                  return i2.setHasTrailingDivider(n4), n4 ? i2.classList.add(s) : i2.classList.remove(s), e4;
                }, insertBeforeMenuItem: function(t4, n4) {
                  var i2 = m2(t4), o2 = y2(n4);
                  return f2.insertMenuItem(i2, { before: o2 }), e4;
                }, moveToSubmenu: function(t4) {
                  var n4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, i2 = y2(t4);
                  if (n4 === null)
                    f2.moveToSubmenu(i2);
                  else if (typeof n4 == "string") {
                    var o2 = y2(n4.toString());
                    f2.moveToSubmenu(i2, o2);
                  } else
                    n4.coreAsWell !== void 0 || n4.selector !== void 0 ? f2.moveToSubmenu(i2, null, n4) : console.warn("options neither has coreAsWell nor selector property but it is an object. Are you sure that this is what you want to do?");
                  return e4;
                }, moveBeforeOtherMenuItem: function(t4, n4) {
                  var i2 = y2(t4), o2 = y2(n4);
                  return f2.moveBefore(i2, o2), e4;
                }, disableMenuItem: function(t4) {
                  return y2(t4).disable(), e4;
                }, enableMenuItem: function(t4) {
                  return y2(t4).enable(), e4;
                }, hideMenuItem: function(t4) {
                  return y2(t4).hide(), e4;
                }, showMenuItem: function(t4) {
                  return y2(t4).display(), e4;
                }, destroy: function() {
                  return v2(), e4;
                } };
              }(this);
            ...
            var i = n2(621).contextMenus, o = function(e3) {
              e3 && e3("core", "contextMenus", i);
            };
            typeof cytoscape != "undefined" && o(cytoscape), e2.exports = o;
          } }, t = {};
          function n(i) {
            var o = t[i];
            if (o !== void 0)
  ...
  var import_cytoscape_context_menus = __toESM(require_cytoscape_context_menus());
  import_cytoscape.default.use(import_cytoscape_context_menus.default);
  var escad = {};
  var cy = {};
  ...
  function displayError(text) {
    ...
    document.getElementById("message").textContent = "\u{1F61F}" + text;
  }
  function displayInfo(text) {
    document.getElementById("message").className = "info";
    document.getElementById("message").textContent = "\u{1F642}" + text;
  }
  ...
  function getDBgraph() {
    fetch("http://127.0.0.1:8529/_db/thesis/_api/document/thesis_prozess/CAD", { headers: { Authorization: arango_authorization } }).then(function(response) {
      if (response.ok) {
    ...
    escad = {
      relations: [
        { id: "r0", name: "R0", from: "bob", to: "jane" },
  ...
  function InitGraph(cy2) {
    getDBgraph();
    escad.symbols.forEach((element) => cy2.add({ group: "nodes", data: { id: element.id, name: element.name, weight: 75 }, position: { x: element.x, y: element.y } }));
    escad.relations.forEach((element) => cy2.add({ group: "edges", data: { id: element.id, source: element.from, target: element.to, name: "none" } }));
  }
  function newSymbol(opts) {
    var id = opts.data.id === "" ? "s" + escad.sym_counter++ : opts.data.id;
    var pos = opts.position === void 0 ? { x: 0, y: 0 } : opts.position;
    escad.symbols.push({ id });
    cy.add({ group: "nodes", data: { id }, position: pos });
    setSymbol(opts);
  }
  function saveObject() {
  ...
  function setSymbol(opt_s = { group: "nodes", position: { x: 0, y: 0 } }) {
    ...
    let index = escad.symbols.findIndex((element) => element.id == opts.data.id);
    if (index == -1) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    cy = window.cy = (0, import_cytoscape.default)({
        ...
        },
        {
          ...
          onClickFunction: function(event) {
            ...
            if (selectedNodes.length === 2) {
              cy.add([{ group: "edges", data: { id: "e0", source: selectedNodes[0].json().data.id, target: selectedNodes[1].json().data.id } }]);
            } else {
