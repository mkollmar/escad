...
\begin{tikzpicture}[
      ...
      \node[sym] (view) [below=of configuration] {$\_view$}; %
      \node[sym] (web) [below=of view] {$\_web$};
      
      \node[sym] (message) [right=of configuration] {$\_message$}; %
    ...
    % \node[sym] (s3) [left=of s2] {$s_3$};
      \draw[-{Latex[width=3mm, length=3mm]}] (escad) -- (configuration) node [pos=0.03, above, color=red] {ref\_to} node [pos=0.1, left, color=red] {ref\_from} node [pos=0.7, left, color=red] {ref\_to} node [pos=1.0, below, color=red] {ref\_from};
      \draw[-{Latex[width=3mm, length=3mm]}] (escad) to[out=185, in=150, looseness=1] (view);
